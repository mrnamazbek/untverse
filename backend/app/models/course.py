...
from sqlalchemy import String, Boolean, Integer, Text, ForeignKey, UniqueConstraint, DateTime
...
class Topic(Base, TimestampMixin):
    ...
    quizzes: Mapped[List["Quiz"]] = relationship(
        "Quiz", back_populates="topic", cascade="all, delete-orphan"
    )
    coding_tasks: Mapped[List["CodingTask"]] = relationship(
        "CodingTask", back_populates="topic", cascade="all, delete-orphan"
    )
    ...
    translations: Mapped[List["TopicTranslation"]] = relationship(
        "TopicTranslation", back_populates="topic", cascade="all, delete-orphan"
    )
...
class Lesson(Base, TimestampMixin):
    ...
    translations: Mapped[List["LessonTranslation"]] = relationship(
        "LessonTranslation", back_populates="lesson", cascade="all, delete-orphan"
    )
