...
class Quiz(Base, TimestampMixin):
    ...
    quiz_type: Mapped[str] = mapped_column(
        String(50), default=QuizType.STANDARD.value, nullable=False, index=True
    )
...
class Question(Base, TimestampMixin):
    ...
    question_type: Mapped[str] = mapped_column(
        String(50), default=QuestionType.SINGLE_CHOICE.value, nullable=False, index=True
    )
    ...
    extra_data: Mapped[Optional[dict]] = mapped_column(
        JSON, nullable=True
    )  # for matching pairs or gap options
    ...
    mistakes: Mapped[List["MistakeLog"]] = relationship(
        "MistakeLog", back_populates="question", cascade="all, delete-orphan"
    )
...
class QuizAnswer(Base, TimestampMixin):
    ...
    attempt_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("quiz_attempts.id", ondelete="CASCADE"), index=True, nullable=False
    )
    question_id: Mapped[int] = mapped_column(
        Integer, ForeignKey("questions.id", ondelete="CASCADE"), index=True, nullable=False
    )
